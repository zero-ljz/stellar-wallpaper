...
[![Release](https://img.shields.io/badge/version-v1.2.3-brightgreen.svg)](https://github.com/zero-ljz/stellar-wallpaper/releases)
...
8. **❤️ 收藏夹与 📜 历史记录**
   ...
   - 收藏夹支持跨页批量勾选、全选全部收藏、下载进度、取消任务和自动跳过已有文件。
